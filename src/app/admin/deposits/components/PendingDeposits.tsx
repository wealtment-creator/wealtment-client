...
// import { apiGetAllDeposits, apiFundUser , apiApproveDeposit } from "@/lib/api";
...
// }
// function userEmail(d: Deposit) {
//   return typeof d.user === "object" && d.user !== null ? d.user.email : "—";
// }
...
//       setDeposits(Array.isArray(res) ? res.filter((d)=>d.status==="pending") : []);
...
//               {filtered.length === 0 ? (
//                 <p className="text-center text-[var(--muted)] text-sm py-14">No pending deposits found.</p>
//               ) : filtered.map((d) => {
//                const usd = d.amount; 
